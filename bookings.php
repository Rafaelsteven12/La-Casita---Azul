...
<html lang="en">
 <head>
    ...
    <title>LA CASITA HOTEL - BOOKINGS</title>
...
$result = select($query, [$_SESSION['uId']], 'i');
    ...
    {
      if(confirm('The reservation price is non-refundable. Are you sure to cancel this boooking? '))
      {
