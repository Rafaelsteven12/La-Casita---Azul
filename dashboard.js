function booking_analysis(period=1)
{
   ...
   xhr.onload = function(){ 
      ...
      document.getElementById('total_amt').textContent = 'Php:'+data.total_amt;

      document.getElementById('active_bookings').textContent = data.active_bookings;
      document.getElementById('active_amt').textContent = 'Php:'+data.active_amt;

      document.getElementById('cancelled_bookings').textContent = data.cancelled_bookings;
      document.getElementById('cancelled_amt').textContent = 'Php:'+data.cancelled_amt;
   }
