<?php
   ...
   //frontend purpose data
    ...
    define('SITE_URL','http://127.0.0.1/hotel_management/hotel_system-main/');
 ...
 //backend upload process requires this data
  ...
  define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/hotel_management/hotel_system-main/images/');
